                      ...
                      <>
                        <td className="py-2 pr-4">
                          <input
                            ...
                            value={editState.vendor_pattern}
                            onChange={e => setEditState(s => ({ ...s, vendor_pattern: e.target.value }))}
                          />
                        </td>
                        <td className="py-2 pr-4">
                          <input
                            className="w-full border border-gray-300 rounded px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-blue-500"
                            value={editState.merchant_name}
                            onChange={e => setEditState(s => ({ ...s, merchant_name: e.target.value }))}
                          />
                        </td>
                        <td className="py-2 pr-4">
                          <input
                        ...
                        <td className="py-2 text-right whitespace-nowrap">
                          <button
                            ...
                            className="text-xs text-blue-600 hover:text-blue-800 font-medium mr-3 disabled:opacity-50"
                          >
